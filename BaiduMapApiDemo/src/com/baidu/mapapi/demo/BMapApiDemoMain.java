...
public class BMapApiDemoMain extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		//直接可以把组数传给ArrayAdapter，下面几句是多余的
		...
		// 添加ListItem，设置事件响应
        mListView.setAdapter((ListAdapter) new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,mStrDemos ));
    ...
    void onListItemClick(int index) {
		...
		Intent intent = null;
		//这要非常好啊，将要跳转的.Class用数组存起来，免得要用switch...case那样麻烦
